...
<section class="py-24 relative  bg-background font-playfair ">
<div class="w-full max-w-7xl px-4 md:px-5 lg-6 mx-auto py-6 px-auto shadow-xl rounded-md">

    <h2 class="title font-manrope font-bold text-4xl leading-10 mb-8 text-center text-primary">Cart
    </h2>
    <div class="hidden lg:grid grid-cols-2 py-6">
        <div class=" text-xl leading-8 text-secondary font-playfair font-bold">Les plats</div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 min-[550px]:gap-6 border-t border-gray-200 py-6">
        <div class="flex items-center flex-col min-[550px]:flex-row gap-3 min-[550px]:gap-6 w-full max-xl:justify-center max-xl:max-w-xl max-xl:mx-auto">
            ...
            <div class="pro-data w-full max-w-sm ">
                <h5 class="font-semibold text-xl leading-8 text-secondary max-[550px]:text-center">plat</h5>
                <p class="font-normal text-lg leading-8 text-text my-2 min-[550px]:my-3 max-[550px]:text-center"></p>
                <h6 class="font-medium text-lg leading-8 text-accent  max-[550px]:text-center">120.00dh</h6>
            </div>
        </div>
    ...
    <div class="bg-gray-50 rounded-xl p-6 w-full mb-8 max-lg:max-w-xl max-lg:mx-auto">
        <div class="flex items-center justify-between w-full mb-6">
            <p class="font-normal text-xl leading-8 text-text">Le Total</p>
            <h6 class="font-semibold text-xl leading-8 text-secondary">360.00 Dh</h6>
        </div>
        <div class="flex items-center justify-between w-full pb-6 border-b border-gray-200">
            <p class="font-normal text-xl leading-8 text-text">Delivery</p>
    ...
    <div class="w-full max-w-7xl px-4 md:px-5 lg-6 mx-auto py-6 px-auto shadow-xl rounded-md">
        ...
        <div class="flex items-center flex-col sm:flex-row justify-center gap-3 mt-8">
            ...
            <form action="{{ route ("session") }}" method="get">
                @csrf
            <button class="rounded-full w-full max-w-[280px] py-4 text-center justify-center items-center bg-accent font-semibold text-lg text-white flex transition-all duration-500 hover:bg-indigo-700">Continue to Payment
               <a href="{{ route('session') }}"></a> <i class="fas fa-arrow-right"></i>
            </button>
        </form>
        </div>
    </div>
