...
<x-guest-layout>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div>
            ...
            <label for="email" :value="__('Email') "class="text-accent">Email</label>
        ...
        <div class="mt-4">
            ...
            <label for="password" :value="__('Password') "class="text-accent">Password</label>
        ...
        <div class="flex items-center justify-end mt-4 gap-5">
            ...
            <button class="rounded-2xl w-20  bg-accent">
                {{ __('Log in') }}
            </button>
        </div>
    </form>
